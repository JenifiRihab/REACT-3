        ...
        <div>
          ...
          {coworkings.map((coworking) => (
            ...
            <div key={coworking.id}>
              ...
              <p> <strong>Adresse :{coworking.address.number} {coworking.address.street} - {coworking.address.postcode}{coworking.address.city} </strong> </p>

              <br />

              <Link to={`/admin/coworkings/${coworking.id}/update`}> <h4>Mettre à jour le coworking </h4></Link>
